 ...
 */
class Unbxdsearch_Ucatalog_Model_Layer_Filter_Category extends Mage_Catalog_Model_Layer_Filter_Abstract
{
    /**
     * Active Category Id
     *
    ...
    protected function _getItemsData()
    {
        ...
        if ($data === null) {
            ...
            foreach($filters as $filter){
            	if($filter->keyName=="category"){
            		$items=$filter->getItems();
            		foreach($items as $item){
            			#error_log($item->getLabel());
            			$collection=Mage::getModel('catalog/category')->getCollection()->addAttributeToFilter('Name',$item->getLabel())->load();
