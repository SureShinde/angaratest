 ...
 */
class Mage_Review_Block_Customreviewform extends Mage_Core_Block_Template
{
    public function __construct()
    {
		...
		$sequenceNumber = $this->getRequest()->getParam('s');
		$orderId = $this->getRequest()->getParam('order');
		$email = $this->getRequest()->getParam('email');
		
		if(isset($sequenceNumber) AND !empty($sequenceNumber)) {
        ...
        $this->setTemplate('review/customreviewform.phtml')
            ->assign('data', $data)
    ...
    public function getAction()
    {
        ...
        return Mage::getUrl('customerreview/index/reviewpost/');
    }
