...
class Mage_Review_Model_Resource_Review extends Mage_Core_Model_Resource_Db_Abstract
{
    ...
    protected function _afterSave(Mage_Core_Model_Abstract $object)
    {
        ...
        $detail = array(
			...
			'order_id' =>  $object->getRealOrderId(), // Custom Field Added by Vaseem so that the record can be saved in DB
        );
        ...
        if ($detailId) {
            ...
            if($detail['order_id']==0||$detail['order_id']==NULL||$detail['order_id']==' ')
