...
class Mage_Review_Model_Resource_Review_Product_Collection extends Mage_Catalog_Model_Resource_Product_Collection
{
    ...
    protected function _joinFields()
    {
		...
		$ratingOptionVoteTable	=	Mage::getSingleton('core/resource')->getTableName('rating_option_vote');		//	S:VA	Added join in Grid
        ...
        $this->getSelect()
            ->join(array('rt' => $reviewTable),
                ...
                array('rt.review_id', 'review_created_at'=> 'rt.created_at', 'rt.entity_pk_value', 'rt.status_id','rt.type_status_id'))
            ->join(array('rdt' => $reviewDetailTable),
                'rdt.review_id = rt.review_id',
                array('rdt.title','rdt.nickname', 'rdt.order_id', 'rdt.detail', 'rdt.customer_id', 'rdt.store_id'))	//	S:VA
			//	S:VA	Added join in Grid	
			->join(array('rov' => $ratingOptionVoteTable),
						'rdt.review_id = rov.review_id',
						array('rov.value'));
        return $this;
    }
    ...
    public function setOrder($attribute, $dir = 'DESC')
    {
        switch($attribute) {
            ...
            case 'rdt.title':
            case 'rdt.nickname':
			case 'rdt.order_id':	//	S:VA
			case 'rov.value':		//	S:VA	Added join in Grid
            case 'rdt.detail':
