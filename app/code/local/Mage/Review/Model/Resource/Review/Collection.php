...
class Mage_Review_Model_Resource_Review_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
    ...
    protected function _construct()
    {
        ...
        $this->_rateSummaryTable    =$this->getTable('rating/rating_option_vote');
    }
    ...
    protected function _initSelect()
    {
     ...
     if($pageType == 'product'){
            ...
            ->join(array('detail' => $this->_reviewDetailTable),
                ...
                array('detail_id', 'title', 'detail', 'nickname', 'customer_id', 'order_id'))
            ->join(array('rating' => $this->_rateSummaryTable),
    ...
    public function setRateOrder($dir = 'DESC')
    {
        $this->setOrder('rating.value', $dir);
        return $this;
    }
