...
class Mage_Adminhtml_Block_Sales_Order extends Mage_Adminhtml_Block_Widget_Grid_Container
{
	...
	{
		if(Mage::getSingleton('admin/session')->isAllowed('adminhtml_card')){
			$this->_addButton('add_new', array(
				'label'   => Mage::helper('card')->__('Add New Card'),
				'onclick' => "setLocation('{$this->getUrl('admin_card/adminhtml_card/new')}')",
				'class'   => 'add'
			));
	 	}
		//$this->setChild('grid', $this->getLayout()->createBlock('card/adminhtml_card_edit', 'card.grid'));
