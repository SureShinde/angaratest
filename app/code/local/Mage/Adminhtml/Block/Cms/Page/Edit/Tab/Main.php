    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    protected function _prepareForm()
    {
		...
		$fieldset->addField('custom_title', 'text', array(
            'name'     => 'custom_title', // This is the same as the column you had created within the cms_page table
            'label'    => Mage::helper('cms')->__('Custom Title For SEO'), // This is the backend label of the field
            'required' => false, // Is this field required?
            'disabled' => $isElementDisabled // Is the field disabled?
        ));
        //Title suffix
        $fieldset->addField('title_suffix', 'text', array(
            'name'     => 'title_suffix', // This is the same as the column you had created within the cms_page table
            'label'    => Mage::helper('cms')->__('Title Suffix'), // This is the backend label of the field
            'required' => false, // Is this field required?
            'disabled' => $isElementDisabled // Is the field disabled?
        ));
        //End title suffix
