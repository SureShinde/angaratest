...
class Mage_Adminhtml_Block_Promo_Quote_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
		...
		$this->addColumn('rule_valid_on', array(
            'header'    => 	Mage::helper('salesrule')->__('Rule Valid For'),
            'align'     =>	'right',
            'width'     => 	'50px',
            'index'     => 	'rule_valid_on',
			'type' 		=> 	'options',
		...
		$this->addColumn('discount_amount', array(
            'header'    => Mage::helper('salesrule')->__('Discount'),
            'align'     => 'left',
            'width'     => '100px',
		...
		$this->addColumn('simple_action', array(
            'header'    => Mage::helper('salesrule')->__('Discount Type'),
            'align'     => 'left',
            'width'     => '100px',
            'index'     => 'simple_action',
        ));
