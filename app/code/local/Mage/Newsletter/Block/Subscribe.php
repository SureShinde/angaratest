...
class Mage_Newsletter_Block_Subscribe extends Mage_Core_Block_Template
{
	...
	/*
		S:VA
		Retrieve newsletter type(it ll save in admin)
		@return string
	*/
	public function getNewsletterType(){
		$currentUrl		=	Mage::helper('core/url')->getCurrentUrl();
		if(stristr($currentUrl, 'black-friday')){
			return 'black-friday';
		}elseif(stristr($currentUrl, 'cyber-monday')){
			return 'cyber-monday';
		}elseif(stristr($currentUrl, 'green-monday')){
			return 'green-monday';
		}else{
			return '03-footer';
		}
