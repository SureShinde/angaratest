...
class Mage_Page_Block_Html_Footer extends Mage_Core_Block_Template
{
    ...
    protected function _construct1223()
    {
     ...
     * @return array
     */
    public function getCacheKeyInfo123()
    {
		$pageCacheType = 1;
		$pageType = Mage::app()->getRequest()->getModuleName();
		if($pageType == 'onepagecheckout' || $pageType == 'checkout') {
			$pageCacheType = 2;
		}
        return array(
            'PAGE_FOOTER',
			...
			Mage::getModel('countrymapping/country')->getCountryParamCode(),
			$pageCacheType
        );
    }
