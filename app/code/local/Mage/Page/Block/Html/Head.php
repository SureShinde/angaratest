...
class Mage_Page_Block_Html_Head extends Mage_Core_Block_Template
{
    ...
    public function getCssJsHtml()
    {
        ...
        foreach ($lines as $if => $items) {
			...
			// Angara version control modification for css/js file - please change v variable values from live if you are pushing related to css and js - anil jain - 19082013
            // static and skin css
			$cssVersionNumber = Mage::helper('flashsale')->getCssVersion();	//	S:VA	Css Versioning
			...
			$jsVersionNumber = Mage::helper('flashsale')->getJsVersion();	//	S:VA	Js Versioning
    ...
    protected function _separateOtherHtmlHeadElements(&$lines, $itemIf, $itemType, $itemParams, $itemName, $itemThe)
    {
        ...
        switch ($itemType) {
            ...
            $currentUrl 	= Mage::helper('core/url')->getCurrentUrl();
               //	S:VA	Adding ?p=4 for paginated catalog pages
			if( $pageType == 'category' && $current_page > 1 ){
				if(is_numeric($current_page)) {
					$currentPage 	= 	$this->__('?p=').$current_page;
    ...
    public function getTitle()
    {
		...
		//	S:VA	Setting blank category title, if there is nothing set in the meta title
    ...
    public function getDescription()
    {
		...
		//	S:VA	Setting blank category description, if there is nothing set in the meta description
		$product  = Mage::registry('current_product');
		$category = Mage::registry('current_category');
		if(!$product && $category){
    ...
    public function getKeywords()
    {
		...
		//	S:VA	Setting blank category keywords, if there is nothing set in the meta keywords
		$product  = Mage::registry('current_product');
		$category = Mage::registry('current_category');
		if(!$product && $category){
