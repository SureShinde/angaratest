...
class Mage_CatalogSearch_Block_Result extends Mage_Core_Block_Template
{
    ...
    protected function _getProductCollection()
    {
        if (is_null($this->_productCollection)) {
			// Angara Modification Start
			//$this->_productCollection = $this->getListBlock()->getLoadedProductCollection(); // commented by anil jain - 05-04-2012
			$this->_productCollection = Mage::getSingleton('catalogsearch/layer')->getProductCollection(); // added new line by anil by anil jain - 05-04-2012
			// Angara Modification End
        }
	...
	public function getRefinedQueries()
    {
        return $this->_getQuery()->getRefinedSearches();
    }
