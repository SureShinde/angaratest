...
class Mage_Catalog_Model_Product_Link_Api extends Mage_Catalog_Model_Api_Resource
{
    ...
    protected $_typeMap = array(
		...
		'matchingband'	=> Mage_Catalog_Model_Product_Link::LINK_TYPE_MATCHINGBAND,
        'grouped'       => Mage_Catalog_Model_Product_Link::LINK_TYPE_GROUPED,
		'gemstonecolor'	=> Angara_Gemstonecolor_Block_Adminhtml_Catalog_Product_Edit_Tab_Gemstonecolor::LINK_TYPE_GEMSTONECOLOR,
    );
