...
abstract class Mage_Catalog_Block_Layer_Filter_Abstract extends Mage_Core_Block_Template
{
	...
	/**
     * Get all filter items sorted by count in descending order
     * Author: Hitesh Agarwal
     * @return array
     */
	public function getItemsSortedByCountDesc()
    {
		$items = $this->getItems();
		usort($items,array($this, '_compareItems'));
		return $items;
		
    }

	/*	
	*	helper function to sort items by count
	*/
