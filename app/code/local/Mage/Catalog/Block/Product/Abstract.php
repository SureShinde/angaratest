...
abstract class Mage_Catalog_Block_Product_Abstract extends Mage_Core_Block_Template
{
    ...
    protected $_productPriceBlockDefaultTemplate = 'catalog/product/product-price.phtml';

    protected $_overlayProductPriceBlockDefaultTemplate = 'catalog/product/overlay-product-price.phtml';
    ...
    protected function _getProductPriceBlockTemplate($productTypeId)
    {
        if (isset($this->_priceBlockTypes[$productTypeId])) {
            if ($this->_priceBlockTypes[$productTypeId]['template'] != '') {
                return $this->_priceBlockTypes[$productTypeId]['template'];
        ...
        return $this->_productPriceBlockDefaultTemplate;
    }
    
    protected function _getOverlayProductPriceBlockTemplate($productTypeId)
    {
        if (isset($this->_priceBlockTypes[$productTypeId])) {
            if ($this->_priceBlockTypes[$productTypeId]['template'] != '') {
                return $this->_priceBlockTypes[$productTypeId]['template'];
        ...
        return $this->_overlayProductPriceBlockDefaultTemplate;
    }
     ...
     * @return Mage_Core_Block_Template
     */
    public function _prepareProductPriceRenderer($productType)
    {
        return $this->_getPriceBlock($productType)
            ->setTemplate($this->_getProductPriceBlockTemplate($productType))
            ->setUseLinkForAsLowAs($this->_useLinkForAsLowAs);
    }
     ...
     * @return Mage_Core_Block_Template
     */
    public function _prepareOverlayProductPriceRenderer($productType)
    {
        return $this->_getPriceBlock($productType)
            ->setTemplate($this->_getOverlayProductPriceBlockTemplate($productType))
            ->setUseLinkForAsLowAs($this->_useLinkForAsLowAs);
    }
     ...
     * @return string
     */
    public function getProductPriceHtml($product, $displayMinimalPrice = false, $idSuffix = '')
    {
        return $this->_prepareProductPriceRenderer($product->getTypeId())
            ->setProduct($product)
            ->setDisplayMinimalPrice($displayMinimalPrice)
            ->setIdSuffix($idSuffix)
            ->toHtml();
     ...
     * @return string
     */
    public function getOverlayProductPriceHtml($product, $displayMinimalPrice = false, $idSuffix = '')
    {
        return $this->_prepareOverlayProductPriceRenderer($product->getTypeId())
            ->setProduct($product)
            ->setDisplayMinimalPrice($displayMinimalPrice)
            ->setIdSuffix($idSuffix)
            ->toHtml();
