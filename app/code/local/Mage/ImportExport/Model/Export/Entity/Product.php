    ...
    protected function _prepareLinks(array $productIds)
    {
        ...
        $select = $adapter->select()
            ...
            ->where('cpl.link_type_id IN (?)', array(
				...
				Mage_Catalog_Model_Product_Link::LINK_TYPE_MATCHINGBAND,
				Angara_Gemstonecolor_Block_Adminhtml_Catalog_Product_Edit_Tab_Gemstonecolor::LINK_TYPE_GEMSTONECOLOR,
    ...
    public function export()
    {
        ...
        while (true) {
            ...
            $linkIdColPrefix = array(
				...
				Mage_Catalog_Model_Product_Link::LINK_TYPE_MATCHINGBAND => '_links_matchingband_',
				Angara_Gemstonecolor_Block_Adminhtml_Catalog_Product_Edit_Tab_Gemstonecolor::LINK_TYPE_GEMSTONECOLOR => '_links_gemstonecolor_',
