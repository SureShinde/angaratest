...
$installer->addAttribute('catalog_category', 'category_buy_guides',  array(
    'type'     => 'varchar',
    'label'    => 'Buying Guides',
    'input'    => 'textarea',
...
$installer->addAttributeToGroup(
    ...
    $attributeGroupId,
    'category_buy_guides',
    '14'                    //last Magento's attribute position in General tab is 10
);
 
$attributeId = $installer->getAttributeId($entityTypeId, 'category_buy_guides');
