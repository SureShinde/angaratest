...
<?php
            ...
            class Angara_Matching_IndexController extends Mage_Core_Controller_Front_Action
            {
				...
				{	
					...
					//	Change done by Vaseem for sending matchin emails
					$collection = Mage::getModel('matching/right')->getCollection()->addFieldToFilter('id',array('from' =>'1001','to'=> '5000'));
				...
				public function dataAction()
				{
					...
					//$collection =Mage::getModel('matching/matchingdata')->getCollection()->addFieldToFilter('customer_email',$checkemail);					
					$collection =Mage::getModel('matching/matchingdata')->getCollection()->addFieldToFilter('matching_id', array('from' =>'8001', 'to' => '10768'));
