 ...
 */
class Angara_OutofStockSubscription_Adminhtml_SubscriberController extends Mage_Adminhtml_Controller_Action
{
    ...
    { 
         ...
         */
        $this->_setActiveMenu('catalog/outofstocksubscription');

		/**
		 * Set page title
		 */
		$this->_title($this->__('Catalog'))
             ->_title($this->__('Out of Stock Subscribers'));
        $this->_addContent(
    ...
    {
        return Mage::getSingleton('admin/session')->isAllowed('catalog/outofstocksubscription');
    }
}