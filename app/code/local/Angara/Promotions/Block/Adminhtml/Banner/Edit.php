...
class Angara_Promotions_Block_Adminhtml_Banner_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
		...
		public function getHeaderText()
		{
				if( Mage::registry("banner_data") && Mage::registry("banner_data")->getId() ){
				    ...
				    return Mage::helper("promotions")->__("Edit Item '%s'", $this->htmlEscape(Mage::registry("banner_data")->getId()));
