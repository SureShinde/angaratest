 ...
 */
class Angara_UtilityBackend_Block_Rewrite_Rss_Catalog_Salesrule extends Mage_Rss_Block_Abstract
{
    ...
    protected function _toHtml()
    {
        ...
        foreach ($collection as $sr) {
            ...
            '</tr></table>';
            $url           = Mage::getUrl('');
            $url.='?cid=afl-ls-pf&amp;utm_source=Affiliate&amp;utm_medium=LinkShare&amp;utm_campaign=LinkShare-Feed';
             $data = array(
                 'title'       => $sr->getName(),
