...
class Angara_Gemstonecolor_Block_Adminhtml_System_Config_Frontend_Categories extends Mage_Adminhtml_Block_Catalog_Category_Tree
{
    ...
    {
        parent::__construct();
        $this->setTemplate('gemstonecolor/system/config/categories.phtml');
    }
    ...
    {
    	$values='';
    	$values = Mage::getStoreConfig('gemstonecolors/scategories/allowedm');
    	$values = trim($values,',');
    ...
    {
        return $this->getUrl('adminhtml/adminhtml_gemstonecolor/categoriesJson', array('_secure'=>true,'_nosid'=>true,'_current' => true));
    }
