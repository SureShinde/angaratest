<?php
class Angara_Productbase_Adminhtml_Stones_PricesController extends Mage_Adminhtml_Controller_Action
{
	
    protected function _initAction() {
        return $this->loadLayout()->_setActiveMenu('productbase/prices');
    }

    public function indexAction() { 
		$this->_initAction();
		
		$this->_addContent($this->getLayout()->createBlock('productbase/adminhtml_stones_prices'));
		$this->renderLayout();
	}
    ...
    public function editAction()
    {
        ...
        if ($itemId) {	//edit mode
			$item = Mage::getSingleton('productbase/stone_price')->load($itemId);
