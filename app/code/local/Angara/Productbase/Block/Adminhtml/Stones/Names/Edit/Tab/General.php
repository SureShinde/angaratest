<?php
class Angara_Productbase_Block_Adminhtml_Stones_Names_Edit_Tab_General extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm() 
    {
        ...
        $fieldset = $form->addFieldset('general', array('legend' => $this->__('Stone Information')));
