<?php
class Angara_Reminder_NewslettersignupController extends Mage_Core_Controller_Front_Action
{
	...
	public function setnewsletteremailsessionAction() {
		$email = $_REQUEST['email']; 
		Mage::getSingleton('core/session')->setNewsletterEmail($email);
		
    }
	
	public function setnewsletteremailsessiondownAction() {
		$email = $_REQUEST['emaildown']; 
		Mage::getSingleton('core/session')->setNewsletterEmail($email);
    }
	...
	public function postAction() {
		...
		if($this->getRequest()->isPost()){ 
			...
			if(isset($data['submit_x']) && $data['submit_x']!=''){
