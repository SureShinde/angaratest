...
class Angara_Angaracart_Model_Cart_Observer extends Mage_Core_Model_Abstract
{
	...
	public function checkoutCartProductAddAfter($observer)
    {
		...
		if(Mage::getSingleton('checkout/session')->getCartInit()){
			...
			//Mage::getSingleton('core/session')->addSuccess('Coupon code '.$coupon.' was applied.!');
		}
	}
				...
				if(Mage::getSingleton("checkout/session")->getData("offer_code")){
					...
					switch (Mage::getSingleton('core/session')->getBannertitleSession()) {
						...
						case 'shopshopper':
							...
							break;
						case 'pinterest':
							$autoapply_coupon = Mage::helper('function')->getPinterestCustomerCoupon();
							break;	
						...
						case 'google_paid':
							...
							break;
						case 'bing':
							$autoapply_coupon = Mage::helper('function')->getBingCustomerCoupon();
							break;	
						case 'getprice':
							$autoapply_coupon = Mage::helper('function')->getGetpriceCustomerCoupon();
							break;	
						case 'bizrate':
							$autoapply_coupon = Mage::helper('function')->getBizrateCustomerCoupon();
							break;
						/*case 'returning_visitor':
							$autoapply_coupon = Mage::helper('function')->getReturningVisitorCoupon();
							break;	*/	
						// Code Added by Vaseem Ends
						case 'mobile_cse':
							$autoapply_coupon = Mage::helper('function')->getMobileCseCoupon();
							break;
						/*case 'mobile-pla':
							$autoapply_coupon = Mage::helper('function')->getMobilePlaCoupon();
							break;*/
						case 'mobile_google':
							$autoapply_coupon = Mage::helper('function')->getMobileGoogleCoupon();
							break;
						case 'mobile_bing':
							$autoapply_coupon = Mage::helper('function')->getMobileBingCoupon();
							break;						
					}
				}					
				//	Code modified by Vaseem to get default coupon code values from backend
