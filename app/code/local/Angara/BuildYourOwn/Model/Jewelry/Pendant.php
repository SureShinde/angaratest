<?php
class Angara_BuildYourOwn_Model_Jewelry_Pendant extends Angara_BuildYourOwn_Model_Jewelry
{	
	...
	protected function _getByoSession(){
		$byoSession = Mage::getSingleton('core/session')->getByoPendantSession();
		if(!$byoSession){
	...
	protected function _setByoSession($byoSession){
		Mage::getSingleton('core/session')->setByoPendantSession($byoSession);
	}
