<?php
class Angara_BuildYourOwn_Model_Jewelry_ThreeStoneRing extends Angara_BuildYourOwn_Model_Jewelry
{	
	public function getJewelryType(){
		return 'threeStoneRing';
	}
	
	protected function _getByoSession(){
		$byoSession = Mage::getSingleton('core/session')->getByoThreeStoneRingSession();
		if(!$byoSession){
	...
	protected function _setByoSession($byoSession){
		Mage::getSingleton('core/session')->setByoThreeStoneRingSession($byoSession);
	}
