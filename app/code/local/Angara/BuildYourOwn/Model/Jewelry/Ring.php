<?php
class Angara_BuildYourOwn_Model_Jewelry_Ring extends Angara_BuildYourOwn_Model_Jewelry
{
	...
	protected function _getByoSession(){
		$byoSession = Mage::getSingleton('core/session')->getByoRingSession();
		if(!$byoSession){
	...
	protected function _setByoSession($byoSession){
		Mage::getSingleton('core/session')->setByoRingSession($byoSession);
	}
