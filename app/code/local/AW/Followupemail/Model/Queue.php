  ...
  /*  public function send()
    {
        ...
        } elseif(Mage::helper('smtppro')->isEnabled() AND ! Mage::getStoreConfigFlag('system/smtp/disable')) {
			Mage::log('customsmtp in', null, 'customsmtp.log');
		    $customSMTPTransport = Mage::helper('smtppro')->getTransport();
