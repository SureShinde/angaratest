...
class AW_Rma_Model_Source_Owner
{
	...
	//	S:VA	-	Created to show admin name in RMA comments
	public static function getOptionLabelAdmin($value)
    {
        $adminData 		= Mage::getModel('admin/user')->load($value)->getData();
		$userFirstname 	= $adminData['firstname'];
		$userLastname 	= $adminData['lastname'];
