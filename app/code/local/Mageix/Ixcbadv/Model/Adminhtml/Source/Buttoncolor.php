...
class Mageix_Ixcbadv_Model_Adminhtml_Source_Buttoncolor {
	...
	public function toOptionArray()
	{
		return array(
			...
			array('value' => 'DarkGray', 'label' => Mage::helper('adminhtml')->__('DarkGray')),
			array('value' => 'LightGray',   'label' => Mage::helper('adminhtml')->__('LightGray')),
