...
class Mageix_Ixcbadv_Model_Adminhtml_Source_Widgetsheight {
	...
	{
		return array(
			array('value' => '228px', 'label' => Mage::helper('adminhtml')->__('228px')),
			array('value' => '240px', 'label' => Mage::helper('adminhtml')->__('240px')),
			array('value' => '260px', 'label' => Mage::helper('adminhtml')->__('260px')),
			array('value' => '275px', 'label' => Mage::helper('adminhtml')->__('275px')),
			array('value' => '300px', 'label' => Mage::helper('adminhtml')->__('300px')),
			array('value' => '325px', 'label' => Mage::helper('adminhtml')->__('325px')),
			array('value' => '350px', 'label' => Mage::helper('adminhtml')->__('350px')),
			array('value' => '375px', 'label' => Mage::helper('adminhtml')->__('375px')),
