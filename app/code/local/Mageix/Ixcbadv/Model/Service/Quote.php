...
class Mageix_Ixcbadv_Model_Service_Quote extends Mage_Sales_Model_Service_Quote
{
	public function submitOrder()
    {
		$quote = $this->_quote;
		$resere_order_id = $quote->getReservedOrderId();
		if(preg_match("/AP-/is", $resere_order_id)){
