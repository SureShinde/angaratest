...
class Mageix_Ixcbadv_Block_Inline_Form extends Mage_Payment_Block_Form
{
    protected function _construct()
    {
		$mark = Mage::getConfig()->getBlockClassName('core/template');
        $mark = new $mark;
		$mark->setTemplate('ixcbadv/inline/mark.phtml');
        $this->setTemplate('ixcbadv/inline/form.phtml')
            ->setMethodTitle('')
