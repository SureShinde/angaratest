...
class Mageix_Ixcbadv_Block_Inline_Bottomlink extends Mage_Core_Block_Template
{
	...
	public function getWidget ($jswidgetname , $div, $element, $urlPath, $checkouturl) {
		...
		$backgroundval = Mage::getStoreConfig('ixcbadv/mageix_button/button_bg_ixcbadv');
		return "
			if (window['$jswidgetname'] == undefined){
					...
					$jswidgetname.createInlineWidget('".$urlPath."', inlinecallback, 'checkout', '".$sizeval."', '".$colorval."', '".$backgroundval."');
