...
class Mageix_Ixcbadv_Block_Inline_Accountlogin extends Mage_Checkout_Block_Onepage_Abstract
{
    protected function _construct()
    {
        $this->getCheckout()->setStepData('accountlogin', array(
            'label'     => Mage::helper('checkout')->__('Account Login'),
            'is_show'   => $this->isShow()
        ));
