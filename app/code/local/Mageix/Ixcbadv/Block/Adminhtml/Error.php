...
class Mageix_Ixcbadv_Block_Adminhtml_Error extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    public function __construct()
    {
        $this->_controller = 'adminhtml_error';
        $this->_blockGroup = 'ixcbadv';
        $this->_headerText = Mage::helper('ixcbadv')->__('Error Log');
        $this->_addButtonLabel = Mage::helper('ixcbadv')->__('Add Error');
        parent::__construct();
