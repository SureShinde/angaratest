...
class Mage_Checkout_CartController extends Mage_Core_Controller_Front_Action
{
    ...
    public function addAction()
    {
        ...
        if (!$this->_validateFormKey()) {
            Mage::log('Add to Cart: Invalid Form Key',null,'empty_cart.log',true);
            $this->_goBack();
            return;
        }
        $cart   = $this->_getCart();
        ...
        try {
             ...
             */
            if (!$product) {
				Mage::log('Product not available/exist.',null,'empty_cart.log',true);
                $this->_goBack();
                return;
            }
			...
			//$end = microtime(true);
			//echo '<br/>Adding Completed:'.$end-$start;die;
