...
class Magestore_Bannerslider_Block_Adminhtml_Bannerslider_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  protected function _prepareColumns()
  {
	  ...
	  $this->addColumn('Show in', array(
          'header'    => Mage::helper('bannerslider')->__('Show in'),
          'align'     =>'left',
          'index'     => 'is_home',
      ));
	  
	  $this->addColumn('Created', array(
          'header'    => Mage::helper('bannerslider')->__('Created'),
          'align'     =>'left',
          'index'     => 'created_time',
      ));
	  
	  $this->addColumn('Updated', array(
          'header'    => Mage::helper('bannerslider')->__('Updated'),
          'align'     =>'left',
          'index'     => 'update_time',
      ));	
	  /*
