            ...
            if (in_array($fullActionName, $cacheableActions)) {
                ...
                if (in_array($blockName, $dynamicBlocks)) {
                    $placeholder = Mage::helper('fpc/block')
                        ->getPlaceholderHtml($blockName);
					/* echo "{{".$blockName."=".htmlspecialchars($placeholder)."}"; */
					...
					/* echo "{TransportClass=".get_class($observer->getTransport());
					echo "}}"; */
					if(0 && $fullActionName == 'catalog_product_view' || $blockName == 'country') {
