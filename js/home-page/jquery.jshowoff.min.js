	...
	$.fn.jshowoff = function(settings) {
		...
		this.each(function(i) {
			...
			function transitionTo(gallery,index) {
				...
				if(config.effect=='slideLeft'){
				...
				} else if (config.effect=='fade' && !($.browser.msie)) {
					...
					}).find('.custom-scroll').mCustomScrollbar();
					if($cont.children().length>1){
						$cont.children().eq(0).css('position','absolute').fadeOut(config.changeSpeed,function(){$(this).remove();});
					};
				} else if (config.effect=='none' || $.browser.msie) {
			...
			function addControls() {
				$wrap.append('<p class="jshowoff-controls '+uniqueClass+'-controls"><a class="jshowoff-prev '+uniqueClass+'-prev" href="#null">'+config.controlText.previous+'</a> <a class="jshowoff-play '+uniqueClass+'-play" href="#null">'+config.controlText.pause+'</a> <a class="jshowoff-next '+uniqueClass+'-next" href="#null">'+config.controlText.next+'</a></p>');
