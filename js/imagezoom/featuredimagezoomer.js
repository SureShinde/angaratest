...
var featuredimagezoomer={	
	...
	dsetting: { //default settings
			...
			cursorshadecolor: '#fff',		//	Color of small zoom pointer that will appear when you mouse over on big image
			cursorshadeopacity: 0.3,
			cursorshadeborder: '1px solid #F4612E',		//	Border Color of small zoom area that move on big image with the mouse
			cursorshade: false,
	...
	showimage: function($, $tracker, $mag, showstatus){
		...
		//specs.$statusdiv.html('Current Zoom: '+specs.curpower+'<div style="font-size:80%">Use Mouse Wheel to Zoom In/Out</div>');	//	Comment by Vaseem
	...
	magnifyimage: function($tracker, e, zoomrange){
		...
		//specs.$statusdiv.html('Current Zoom: '+specs.curpower)		//	Comment by Vaseem
	...
	init: function($, $img, options){
		...
		$magnifier=$('<div class="magnifyarea" style="position:absolute;width:'+setting.magnifiersize[0]+'px;height:'+setting.magnifiersize[1]+'px;left:-10000px;top:-10000px;visibility:hidden;overflow:hidden;border:1px solid #F4612E;" />')		//	Border of Big Image
