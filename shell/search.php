...
class Mirasvit_Shell_Search extends Mage_Shell_Abstract
{
    public function run()
    {
        if ($this->getArg('engine')) {
            echo get_class(Mage::helper('searchindex')->getSearchEngine())."\n";
        } elseif ($this->getArg('reindex')) {
            echo Mage::helper('searchindex')->getSearchEngine()->reindex()."\n";
        } elseif ($this->getArg('reindex-delta')) {
            echo Mage::helper('searchindex')->getSearchEngine()->reindexDelta()."\n";
