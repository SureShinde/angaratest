...
function open_login() {
	...
	jQuery('#onepagecheckout_login-container').addClass('showcase-bg-dark max-margin-bottom showcase-border-bottom').prev().removeClass('max-margin-bottom');
}
...
jQuery(function(){
	jQuery('.has-subform input, .has-subform select, .has-subform button').focus(function(){
		...
		//jQuery('.subform-index-indicator').removeClass('showcase-bg-green').addClass('showcase-bg-darker');
		//jQuery('.subform-index-indicator:eq('+current_subform_index+')').addClass('showcase-bg-green').removeClass('showcase-bg-darker');
