...
function adj_nav_load_products(transport)
{
	...
	if(jQuery(window).data('view-all') == 'yes'){
		jQuery('.toolbar-bottom').addClass('hidden');
	}	
...
function adj_nav_init()
{
	...
	jQuery('#sort-by-option-holder').html('');
	var sorthtml = jQuery('#sort-by-options').html();
	jQuery('#sort-by-option-holder').append(sorthtml);
