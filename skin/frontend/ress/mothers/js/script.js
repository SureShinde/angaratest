...
;(function($) {
	...
	$(function(){
		$('#special-offer-click').click(function(e){
			...
			var finalPrice = optionsPrice.productPrice; 
			for(var price in optionsPrice.customPrices) 
				finalPrice += optionsPrice.customPrices[price].price;
			...
			if(typeof(productId) != 'undefined'){
				jQuery.get('/promotions/index/index/productId/'+productId+'/additionalCost/'+additionalCost+'/finalPrice/'+finalPrice, function(result){
