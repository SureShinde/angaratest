  ...
  $.fn.Variations = function( config ) {
	...
	var module = this,
		...
		beautifyOption = function(optionClickable, optionContainer, option, attributeId, attribute, parent, optionDetailsContainer){
			...
			switch(attribute.code){
				case 'stone1_size':
					...
					var imageElement = $('<img width="23" height="23" src="' + url + '" />');
		...
		variationsMarkup = function(){
			//var variationsContainer = $('<div class="stone-'+settings.stone1_shape.replace(/\W/,'')+'-'+settings.stone1_name.replace(/\W/,'')+'">').appendTo(container);
			var variationsContainer = $('<div>').appendTo(container);
	...
	module.updateProductDetails = function(productId){
		...
		if (productId){
			...
			//	Code added by Vaseem for not calling jewelProduct function for IE 7
	...
	if(browserVersion==7.0){
		$('.stones-details-box').append('<div class="stone-detail-box-container stone-detail-box'+oddOrEven+'">'+
			...
			'</div>'+
			'<div class="field">'+
				'<div class="fieldtitle">Approximate Dimensions:'+((stone['name'] == 'Ruby' ||  stone['name'] == 'Blue Sapphire' || stone['name'] == 'Emerald' || stone['name'] == 'Tanzanite')?'<span class="popup-icon"></span>':'')+'</div>'+
				'<div class="fieldvalue dyn_stone'+stoneIndex+'_size"></div>'+
				'<div style="clear:both"></div>'+
			'</div>'+
			'<div class="field">'+
				'<div class="fieldtitle">Approximate Carat Total Weight:'+((stone['name'] == 'Ruby' ||  stone['name'] == 'Blue Sapphire' || stone['name'] == 'Emerald' || stone['name'] == 'Tanzanite')?'<span class="popup-icon"></span>':'')+'</div>'+
				'<div class="fieldvalue dyn_stone'+stoneIndex+'_weight"></div>'+
				'<div style="clear:both"></div>'+
			'</div>'+
			'<div class="field">'+
				'<div class="fieldtitle">Quality Grade:'+((stone['name'] == 'Ruby' ||  stone['name'] == 'Blue Sapphire' || stone['name'] == 'Emerald' || stone['name'] == 'Tanzanite' || stone['name'] == 'Diamond' || stone['name'] == 'Enhanced Black Diamond' || stone['name'] == 'Enhanced Blue Diamond')?'<span class="popup-icon"></span>':'')+'</div>'+
			...
			'</div>'+
			'<div class="field">'+
				'<div class="fieldtitle">Quality Grade:'+((stone['name'] == 'Ruby' ||  stone['name'] == 'Blue Sapphire' || stone['name'] == 'Emerald' || stone['name'] == 'Tanzanite' || stone['name'] == 'Diamond' || stone['name'] == 'Enhanced Black Diamond' || stone['name'] == 'Enhanced Blue Diamond')?'<span class="popup-icon" onclick="jewelProduct.showStonePopup(\'stone quality\', \''+stone["name"]+'\', \''+stone["shape"]+'\')"></span>':'')+'</div>'+
				'<div class="fieldvalue dyn_stone'+stoneIndex+'_grade"></div>'+
				'<div style="clear:both"></div>'+
			'</div></div>')
		}
