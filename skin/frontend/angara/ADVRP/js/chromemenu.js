...
dropmenu._curheight=newH+Math.round((maxH-newH)/steps)+5}
...
if(whichedge=="rightedge"){var windowedge=document.all&&!window.opera?this.standardbody.scrollLeft+this.standardbody.clientWidth-190:window.pageXOffset+window.innerWidth-190
...
var windowedge=document.all&&!window.opera?this.standardbody.scrollTop+this.standardbody.clientHeight-150:window.pageYOffset+window.innerHeight-170
