...
class Varien_File_Uploader
{
    ...
    static public function getNewFileName($destFile)
    {
        ...
        if (file_exists($destFile)) {
            ...
            /* AS */
			if( file_exists($fileInfo['dirname'] . DIRECTORY_SEPARATOR . $baseName) ) {
				chmod($fileInfo['dirname'] . DIRECTORY_SEPARATOR . $baseName,0755);
				unlink($fileInfo['dirname'] . DIRECTORY_SEPARATOR . $baseName); 
            }
